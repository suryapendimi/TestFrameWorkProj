...
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(MVCTest.StructureMapConfig), "Configure")]
namespace MVCTest
{
	public static class StructureMapConfig
	{
		public static void Configure()
		{
			IoC.Container.Configure(cfg =>
			{
				...
				cfg.AddRegistry(new ActionFilterRegistry(namespacePrefix: "MVCTest"));
